...
def create_channel():
    ...
    name = cast("java.lang.CharSequence", AndroidString("potiontime_channel_1"))
    description = AndroidString("potiontime_channel_id_1")
    channel_id = AndroidString("potiontime_channel_id_1")
...
def create_notification():
    ...
    builder = NotificationCompatBuilder(context, "potiontime_channel_id_1")
    ...
    builder.setContentText(
        cast("java.lang.CharSequence", AndroidString("🤍Time to use your Potion!🤍"))
    )
    # Set sound
    ...
    compatmanager.notify("potiontime_notification_id_1", builder.build())
